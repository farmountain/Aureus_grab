...
(async ()=>{
  try{
    ...
    const sig1 = signApproval(Object.assign({}, approval1), kp.privateKey);
    ...
    const sig2 = signApproval(Object.assign({}, approval2), kp.privateKey);
    ...
    const sig3 = signApproval(Object.assign({}, approval3), kp.privateKey);
